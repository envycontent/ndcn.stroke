...
#
#  $ bin/test -s ndcn.stroke -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ndcn.stroke.testing.NDCN_STROKE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ndcn/stroke/tests/robot/test_example.robot
#
